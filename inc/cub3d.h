...
int							check_inter(t_game *game, double *step,
								double *inter, t_orientation o);
bool						check_hit(t_game *game, double x, double y);
void						render_line(t_game *game, int ray);
void						put_line(int t_pixel, int b_pixel, int ray,
								t_game *game);
...
void						draw_square(t_game *game, int map_x, int map_y,
								int color);
...
void						check_move(double new_x, double new_y,
								t_game *game);
